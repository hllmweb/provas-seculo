            ...
            <div class="col-xs-2 col-xs-offset-1">
                <div class="hpanel hyellow">
                    <div class="panel-body text-center">
                        ...
                        <img width='50' src="http://10.228.25.63/academico/usuarios/foto?codigo=<?=$this->session->userdata('PVO_USER')?>" class="img-rounded">
...
*/
                       ...
                       WHEN   TRUNC(DT_PROVA) = TRUNC(SYSDATE) AND TO_CHAR(SYSDATE,'HH24:MI') >=  HR_INICIO 
                        ...
                        ELSE 'N' 
                      END PODE_ABRIR 
                      FROM BD_SICA.AVAL_PROVA P WHERE P.NUM_PROVA = '".$q->NUM_PROVA."'");
                                        $res = $query->result_array();
                                       #echo "teste".$res[0]['PODE_ABRIR'];



                                    if ($q->FEZ_PROVA == 0){ // nao fez prova
                                        #if($ativar == false && ($tempo_esgotado == 0 || $proximo == true)){
                                         #   $ativar = TRUE;
                                        if($res[0]['PODE_ABRIR'] == 'S'){ 
