...
$query = $this->db->query("SELECT PI.FEZ_PROVA
  FROM BD_SICA.AVAL_PROVA P 
  INNER JOIN BD_SICA.AVAL_PROVA_INSCRITOS PI ON PI.CD_PROVA = P.CD_PROVA
  WHERE PI.CD_PROVA = '".$this->session->userdata('CES_PROVA')."' AND PI.CD_ALUNO = '".$this->session->userdata('PVO_USER')."'");
  $res = $query->result_array();


  if($res['FEZ_PROVA'] == 1){
    echo "Lamento, Estude mais!";
    exit;
  }
...
<html>
    ...
    <!--body--> <body 
        ...
        <?php #if($serie == 6 && ($materia == 'MATEMÁTICA' || $materia == 'PURTUGUÊS')):
                    ...
                    <div id="PainelQuestaoID" class="row" data-id="<?= $questao->POSICAO ?>" data-questao="<?= $questao->CD_QUESTAO ?>">
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="hpanel hgreen" id='PainelOpcao'>
                                ...
                                <div  class="panel-inline" style='font-size:22px;  display:block; margin-top:20px;'>
                                    <?= $opc; ?>
                                    ...
                                    <?= $prova->formata_texto_com_richtext_alternativa($op['DC_OPCAO']).'<br>'; ?>
            ...
            <div class="col-sm-3">
                <div class="hpanel hyellow">
                    ...
                    <div class="media social-profile clearfix">
                        <a class="pull-left">
                            <img width='50' src="http://intranet/academico/usuarios/foto?codigo=<?= $cd_aluno ?>" class="img-rounded">
                        </a>
